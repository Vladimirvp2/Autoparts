...
<?php
		...
		$mykey_values = get_post_custom_values( 'page_title' );
		foreach ( $mykey_values as $key => $value ) {
			$pageTitle = $value;
		}
		
		$mykey_values = get_post_custom_values( 'page_description' );
		foreach ( $mykey_values as $key => $value ) {
			$pageDesc = $value;
		}
		
		$mykey_values = get_post_custom_values( 'page_keywords' );
		foreach ( $mykey_values as $key => $value ) {
			$pageKeyWords = $value;
		}
